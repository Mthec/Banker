...
public class FaceSetters {
    ...
    public @Nullable Creature retrieveBankerOrNull(Player creator, long id) {
    ...
    public long createIdFor(Creature banker, Player creator) throws TooManyTransactionsException {
        long nextId = firstId;
        ...
        transactions.put(nextId, banker);
